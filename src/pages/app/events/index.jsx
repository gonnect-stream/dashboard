            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <Badge
                  ...
                  color={event.status === "No ar" ? "lime" : (event.status === "Programado" ? "yellow" : "red")}
                >
                  {event.status}
                </Badge>
                ...
                <Dropdown>
                  ...
                  <DropdownMenu>
                    <DropdownItem className={"hover:bg-zinc-700"}>Editar</DropdownItem>
                    <DropdownItem className={"hover:bg-zinc-700"}>Deletar</DropdownItem>
                  </DropdownMenu>
                </Dropdown>
              </div>
            </div>
